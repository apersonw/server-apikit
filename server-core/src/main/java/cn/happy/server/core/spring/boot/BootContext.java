...
public abstract class BootContext extends WebMvcConfigurerAdapter {
    ...
    @Bean
    public abstract AccountHandlerInterceptor accountHandlerInterceptor();
    ...
    @Bean
    public MyI18NResultResponseBodyAdvice responseBodyAdvice() {
        return new MyI18NResultResponseBodyAdvice(){};
    }
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new DempHandlerInterceptor());
    }

    @Override
    public void addArgumentResolvers(List<HandlerMethodArgumentResolver> argumentResolvers) {
        argumentResolvers.add(new AccountParamArgumentResolver(getAccountClass()));
    }

    public abstract Class getAccountClass();
